...
- Designing and Teaching course on “[**Data analysis with Python**]()” for [شرکت داده و اعتبارسنجی تجارت ایرانیان (داتا)](https://datatejarat.ir/), Fall 2025 and Janaury 2026 = آذر و دی ماه 1404. The focus was on explaining and applying CRISP-DM steps while teaching so that steps be understood. 
...
### برنامه ریزی شده - 1405
- ([**آموزش مقدماتی علوم داده با پایتون دانشگاه صنعتی شریف**](https://d-learn.ir/pyds/))، میرامید حاجی‌میرصادقی، علیرضا کدیور، سعید مجیدی، حمیده‌ حسین‌زاده، حسام محمدحسینی؛ از تیر تا مهر 1405.
- ([**کاوش جهان از طریق محاسبات، آموزش مقدماتی شبیه سازی و مدل سازی با پایتون**]())، حسام محمدحسینی؛ تابستان 1405.



### 1404
- **تحلیل داده با پایتون** برای [شرکت داده و اعتبارسنجی تجارت ایرانیان (داتا)](https://datatejarat.ir/)    آذر و دی ماه 1404.
- ([**آموزش مقدماتی علوم داده با پایتون دانشگاه صنعتی شریف**](https://d-learn.ir/pyds/))، میرامید حاجی‌میرصادقی، علیرضا کدیور، سعید مجیدی، حمیده‌ حسین‌زاده، حسام محمدحسینی؛ از خرداد تا شهرویر 1404.
...
-  ([**منتور کاراموزان ایرانسل**]())، سال های  1400 و 1403

### برخی از سوابق تدریس گذشته:
-	تدریس "**نحوه کارکرد الگوریتم چت بات ها**" – دومین هکاتون هوش مصنوعی ایرانسل لبز -  4 ساعته - پاییز 1402 ( تکرار بهار 1403).

-	ویدیوها
-	[روز اول - بخش اول](https://www.youtube.com/watch?v=-jx3WN45Q1g)
-	
-	تدریس **Pandas for data analysis"**" – سمن (NGO) کاریار – پاییز 1401  - طراحی و تدریس دوره 18 ساعته.
-	همکاری در طراحی و تدریس بخشی از دوره "**پایتون برای مهندسین مخابرات**" – شرکت شایگان – زمستان 1401 – دوره 18 ساعته
   - 2 دوره برگزاری برای
       
       - شرکت **رایتل**  
-	تدریس مفاهیم "**شبکه رادیویی موبایل**"، "برنامه نویسی پایتون" و "تحلیل و آنالیز داده با پایتون" به نفرات زیر تیم های خودم در بخش شبکه ایرانسل 
-	حل تمرین درس "**نظریه اطلاعات**" (درس کارشناسی ارشد مهندسی برق مخابرات سیستم – دکتر محمدرضا عارف) – برای 3 دوره ( سال 84 تا 86).
...
<div>
  ...
  <!-- <img src="https://github.com/devicons/devicon/blob/master/icons/r/r-original.svg" title="R" alt="R" width="40" height="40"/>&nbsp;   -->
   ...
   <img src="https://raw.githubusercontent.com/pola-rs/polars-static/master/banner/polars_github_banner.svg" title="Polars" alt="Polars" width="40" height="80"/>&nbsp;
   <img src="https://jorisvandenbossche.github.io/talks/2023_PyDataBerlin_Arrow/img/polars-logo-dark.svg" title="Polars" alt="Polars" width="40" height="40"/>&nbsp;
